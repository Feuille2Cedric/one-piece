...
La banque privilégie maintenant très largement les événements racontés dans les résumés : **8 000 questions narratives** interrogent sur une action, un personnage, un lieu, un groupe ou un élément précis de l’histoire. Elles exploitent aussi les sous-pages `/Histoire` des personnages. Aucun énoncé narratif ne contient de blanc `[…]` ni l’ancien gabarit répétitif « au cœur de cette scène ». Le générateur corrige les articles autour du terme masqué et choisit une interrogation adaptée à la nature réelle de la réponse. Les distracteurs sont eux aussi regroupés par type : personnages avec personnages, lieux avec lieux et équipages avec équipages. Les **3 000 questions faciles, les 3 000 moyennes et 2 000 difficiles sont narratives** ; les réponses récurrentes et les héros principaux sont favorisés dans les niveaux accessibles, tandis que les détails rares descendent vers difficile et impossible.
